...
public class RETC_045_RealEstateMediumAdminAllowToCreatePropertyDetailsBasedOnTheRegionCreated {
	...
	public void setUp() throws Exception {
		...
		genericmeth.SAURL("http://realestatem1.upskills.in/");
	...
	public void validLoginTestAndAdminToCreatePropetyDetailsBasedOnTheRegionCreated() throws InterruptedException {
		...
		genericmeth.assertSoftText("All Properties","//a[@class='wp-first-item current']","xpath", "All Properties text Link Not Displayed");
		System.out.println("Assertion is Passed and All Properties Text Link is Displayed to met as Expected");
		genericmeth.assertSoftText("Add New","//li[@id='menu-posts-property']//ul[@class='wp-submenu wp-submenu-wrap']//li//a[contains(text(),'Add New')]","xpath", "Add New text Link Not Displayed");
		System.out.println("Assertion is Passed and Add New Text Link is Displayed to met as Expected");
		genericmeth.assertSoftText("Features","//a[contains(text(),'Features')]","xpath", "Features text Link Not Displayed");
		System.out.println("Assertion is Passed and Features Text Link is Displayed to met as Expected");
		genericmeth.assertSoftText("Regions","//a[contains(text(),'Regions')]","xpath", "Regions text Link Not Displayed");
		System.out.println("Assertion is Passed and Regions Text Link is Displayed to met as Expected");
		genericmeth.assertSoftText("Properties Settings","//a[contains(text(),'Properties Settings')]","xpath", "Properties Settings text Link Not Displayed");
		...
		Thread.sleep(5000L);
		genericmeth.assertSoftText("None", "//option[contains(text(),'None')]", "xpath", "Option None is Not present in the dropdown");
		genericmeth.assertSoftText("Commercial", "//option[contains(text(),'Commercial')]", "xpath", "Option Commercial is Not present in the dropdown");
		genericmeth.assertSoftText("Apartments", "//option[contains(text(),'Apartments')]", "xpath", "Option Apartments is Not present in the dropdown");	
		Thread.sleep(5000L);
		...
		Thread.sleep(5000L);
		genericmeth.assertSoftText("View post","//a[contains(text(),'View post')]", "xpath", "View post Link is Not Present");
